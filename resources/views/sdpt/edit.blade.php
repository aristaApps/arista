                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="retensi" id="retensi" class="form-control" value="{{ old('retensi', $sdpt->retensi) }}" required>
                        </div>

                        <div class="form-group">
                            <label for="keterangan">Keterangan</label>
                            <select name="keterangan" id="keterangan" class="form-control" required>
                                <option value="Aktif" {{ $sdpt->keterangan == 'Aktif' ? 'selected' : '' }}>Aktif</option>
                                <option value="Inaktif" {{ $sdpt->keterangan == 'Inaktif' ? 'selected' : '' }}>Inaktif</option>
                            </select>
                        </div>
