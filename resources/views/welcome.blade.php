    ...
    <nav class="bg-gray-800 p-4">
        <div class="container mx-auto flex justify-between items-center">
            <div class="flex items-center">
                {{-- <img src="{{ asset('sbadmin2/img/kem.png') }}" alt="Gambar Kem" class="w-10 h-10 rounded-lg mr-2"> --}}
            ...
            <div class="space-x-4">
                ...
                {{-- <a href="{{ route('register') }}" class="text-white py-2 px-4 rounded-full bg-blue-500 hover:bg-blue-600">Register</a> --}}
            </div>
        </div>
    </nav>
        <div class="relative flex flex-col items-center justify-center min-h-screen">
            <section class="container px-6 py-6"> <!-- Mengurangi padding -->
